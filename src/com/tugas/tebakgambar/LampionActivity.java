...
public class LampionActivity extends Activity {
	EditText jawaban;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_lampion);
	...
	public void cekjawaban(View v){
		...
		if (jawabanUser.equals(jawabanBenar)){
			...
			Intent trans = new Intent(getApplicationContext(),JamukuatActivity.class);
			startActivity(trans);
		}else{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.lampion, menu);
		return true;
	}
