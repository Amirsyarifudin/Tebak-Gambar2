...
public class BosanmenganggurActivity extends Activity {
	EditText jawaban;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_bosanmenganggur);
	...
	public void cekjawaban(View v){
		String jawabanBenar = "BOSAN MENGANGGUR";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent trans = new Intent(getApplicationContext(), PoconggalauActivity.class);
			startActivity(trans);
		}else{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.bosanmenganggur, menu);
		return true;
	}
