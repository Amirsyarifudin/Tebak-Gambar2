...
public class DrakulaActivity extends Activity {
	EditText jawaban;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_drakula);
	...
	public void cekjawaban(View v){
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent lelah = new Intent(getApplicationContext(),NasibburukActivity.class);
			startActivity (lelah);	
		}
		else {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.drakula, menu);
		return true;
	}
