...
public class PoconggalauActivity extends Activity {
	EditText jawaban;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_poconggalau);
	...
	public void cekjawaban(View v){
		String jawabanBenar = "POCONG GALAU";
		...
		if(jawabanUser.equals (jawabanBenar)){
			...
			Intent trans = new Intent(getApplicationContext(),MatirasaActivity.class);
			startActivity(trans);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.poconggalau, menu);
		return true;
	}
