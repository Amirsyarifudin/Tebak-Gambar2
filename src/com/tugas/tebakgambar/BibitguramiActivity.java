...
public class BibitguramiActivity extends Activity {
	EditText jawaban;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_bibitgurami);
	...
	public void cekjawaban(View v){
		String jawabanBenar ="BIBIT GURAMI";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent trans = new Intent(getApplicationContext(),DrakulaActivity.class);
			startActivity(trans);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.bibitgurami, menu);
		return true;
	}
